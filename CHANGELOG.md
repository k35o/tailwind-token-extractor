...
- [#5](https://github.com/k35o/tailwind-token-extractor/pull/5) [`0b3f16d`](https://github.com/k35o/tailwind-token-extractor/commit/0b3f16d94a9ff7f0d36932e88e1a9ee0a97c78b8) Thanks [@k35o](https://github.com/k35o)! - Add `tokens.refs`: the immediate `var()` target per light/dark mode for raw custom properties defined as `var(--x)`.
